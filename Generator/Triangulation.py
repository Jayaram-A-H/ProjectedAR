...
def Triangulate(coord1,coord2,pcd,P1,P2):
...
base_options = python.BaseOptions(model_asset_path='Generator/face_landmarker.task')
...
while(1):
    ...
    pcd=Triangulate(coord1=coord1,coord2=coord2,pcd=pcd,P1=P1,P2=P2)
